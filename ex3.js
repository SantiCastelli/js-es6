...
let pacientesAvisos = pacientes.map((pacientes) => pacientes.ultimaVisitaPagada == false ? pacientes = {...pacientes, "avisos": "Paciente mjoroso" } : pacientes = {...pacientes, "avisos": "" });
...
let pacientesLista = pacientes.map((paciente) => paciente = `<li>${paciente.nombre}</li>`)
